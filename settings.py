...
def init():
  ...
  v14= u"回复 100 加UIUC课程群小助手(无限次数)\n"
  v15= u"回复 101 加UIUC硕博新生必备干货群;UIUC本科新生必备干货群(无次数限制)\n"
  v16= u"回复 102 加北美股市Trading技术交流总群1(无次数限制)\n"
  v17= u"回复 103 加UIUC面试算法找工作-九章算法群(无次数限制)\n"
  v18= u"回复 104 加UIUC暑期修学分交流群A(无次数限制)\n"
